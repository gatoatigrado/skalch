...
abstract class ScalaGxlNodeMap() extends NodeFactory {
    ...
    def unaryExpr(code : Int) : String = "Unary" + (code match {
        ...
        case scalaPrimitives.B2D => "DoubleCast"
        case scalaPrimitives.C2D => "DoubleCast"
        case scalaPrimitives.D2D => "DoubleCast"
        case scalaPrimitives.F2D => "DoubleCast"
        case scalaPrimitives.I2D => "DoubleCast"
        case scalaPrimitives.L2D => "DoubleCast"
        case scalaPrimitives.S2D => "DoubleCast"
        case scalaPrimitives.B2F => "FloatCast"
        case scalaPrimitives.C2F => "FloatCast"
        case scalaPrimitives.D2F => "FloatCast"
        case scalaPrimitives.F2F => "FloatCast"
        case scalaPrimitives.I2F => "FloatCast"
        case scalaPrimitives.L2F => "FloatCast"
        case scalaPrimitives.S2F => "FloatCast"
        case scalaPrimitives.B2I => "IntCast"
        case scalaPrimitives.C2I => "IntCast"
        case scalaPrimitives.D2I => "IntCast"
        case scalaPrimitives.F2I => "IntCast"
        case scalaPrimitives.I2I => "IntCast"
        case scalaPrimitives.L2I => "IntCast"
        case scalaPrimitives.S2I => "IntCast"
        case scalaPrimitives.B2L => "LongCast"
        case scalaPrimitives.C2L => "LongCast"
        case scalaPrimitives.D2L => "LongCast"
        case scalaPrimitives.F2L => "LongCast"
        case scalaPrimitives.I2L => "LongCast"
        case scalaPrimitives.L2L => "LongCast"
        case scalaPrimitives.S2L => "LongCast"
