...
public class ScStatsMT {
    ...
    public final ScStatEntry nruns, ncounterexamples, nsolutions, gaRepeated,
            ...
            gaSelectindOtherSame, gaSelectindOtherOptimal,
            gaSelectindSelectedOptimal;
    private ArtificalStatEntry gaTotalSelectind;
    protected long startTime, endTime;
    public static ScStatsMT statsSingleton;
    public ScUserInterface ui;
    public boolean showZero;

    public ScStatsMT(ScUserInterface ui, BackendOptions beOpts) {
        if (ui == null) {
        ...
        showZero = beOpts.statOpts.showZero;
        statsSingleton = this;
    }
    ...
    public void showStatsWithUi() {
        ...
        gaTotalSelectind =
                new ArtificalStatEntry(gaSelectindOtherOptimal.value
                        + gaSelectindOtherSame.value
                        + gaSelectindSelectedOptimal.value,
    ...
    public void showStats(ScStatEntry time, ScStatsModifier modifier) {
        modifier.printEntries(nruns, ncounterexamples, nsolutions,
                gaRepeated, gaRepeatedRecent, gaNMutate, gaNCrossover);
    ...
    private void statAnalysis(ScStatsModifier modifier) {
        modifier.rateWarnGt(gaRepeated, nruns, 0.5f,
                "GA - many repeat evaluations");
        modifier.rateWarnLt(gaSelectindOtherOptimal, gaTotalSelectind,
                0.1f, "GA - pareto optimality rarely replaces individual");
        modifier.rateWarnGt(gaSelectindOtherOptimal, gaTotalSelectind,
                0.5f, "GA - pareto optimality replaces individual too often "
                        + "(random number generator error?)");
        modifier.rateWarnLt(gaSelectindOtherSame, gaTotalSelectind,
                0.1f,
