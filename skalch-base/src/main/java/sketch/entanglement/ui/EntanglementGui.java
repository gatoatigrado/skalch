...
public class EntanglementGui extends EntanglementGuiBase implements
        ListSelectionListener, ActionListener
{
    ...
    public EntanglementGui(Map<Trace, ScStack> traceToStack,
    ...
    public void actionPerformed(ActionEvent event) {
        if ("refineAngel".equals(event.getActionCommand())) {
            final EntanglementGui parent = this;
