...
class MatchingA2Sketch extends AngelicSketch {
    val tests = Array(())
    ...
    def main() {
        ...
        var prevPeople = new Array[Int](n);

        var roundGroupsArray = new Array[Int](n);
        var lastRoundGroupsArray = new Array[Int](n);
        
        {
            var roundGroups = new Array[Array[Int]](groups);
            var curPeople = new Array[Int](n);
