package edu.berkeley.cs.scanmem

import skalch.AngelicSketch
import sketch.dyn.BackendOptions
import sketch.util._

class Scan5Sketch() extends AngelicSketch {
    val tests = Array( () )
...
//            }
        ...
        val mid : Array[Int] = Array(1,3,4,15,16,48,64,255
                ,1*mul2,3*mul2,4*mul2,15*mul2,16*mul2,48*mul2,64*mul2,255*mul2+255
                ,1*mul3,3*mul3,4*mul3,15*mul3)//,16*mul3,48*mul3,64*mul3,255*mul3)
