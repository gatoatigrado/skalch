...
public abstract class gui_0_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        selectInputsLabel
                .setText("Select inputs / tests (use <ctrl> to select multiple)");

        debugPrintoutsLabel.setFont(new java.awt.Font("Dialog", 1, 14));
        debugPrintoutsLabel
                .setText("Debug printouts (select to highlight source)");

        viewSelectionsButton.setIcon(new javax.swing.ImageIcon(getClass()
                .getResource("/oxygen/sync.png"))); // NOI18N
        ...
        solversButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/oxygen/office-chart-ring.png"))); // NOI18N
        ...
        stopButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/oxygen/process-stop.png"))); // NOI18N
        ...
        acceptButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/oxygen/dialog-ok-apply.png"))); // NOI18N
